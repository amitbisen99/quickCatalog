...
// ARCHIVED — this is the pre-rebrand homepage (#4f46e5 indigo theme),
// kept as a backup at /home-old when pages/index.tsx was replaced with
// the #C7FF01 color-refreshed version (formerly pages/home2.tsx). Not
// linked from anywhere in the app and excluded from search indexing
// below; safe to delete once the new homepage is confirmed good.
// Styling for this page only lives in tailwind.config.js (brand-*
// colors, float keyframe) and styles/globals.css (.text-gradient,
// .hero-grid-bg, .feature-tab-*).
...
export default function Home({ indiaPrice, internationalPrice }: HomeProps) {
  ...
  return (
    <div className="bg-brand-bg font-sans text-brand-text antialiased overflow-x-hidden">
      <Seo
        title="Instant Catalog (Archived Homepage) — Build Stunning Product Catalogs in Minutes"
