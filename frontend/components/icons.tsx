...
// Brand marks — filled rather than the app's usual hand-drawn stroke
// style, since they sit on a solid colour circle in the share sheet and
// need to actually read as the WhatsApp/Facebook logos.
...
export function FacebookIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M13.5 21v-8h2.7l.4-3.1h-3.1V8c0-.9.25-1.5 1.55-1.5H16.7V3.7C16.4 3.66 15.4 3.57 14.24 3.57c-2.34 0-3.94 1.43-3.94 4.04V9.9H7.6V13h2.7v8h3.2z" />
    </svg>
  );
}
